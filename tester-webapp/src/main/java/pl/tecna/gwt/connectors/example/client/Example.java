...
public class Example implements EntryPoint {
  ...
  private void loadApplication() { 	
    ...
    boundaryPanel.add(new Label("GWT-Connectors Example Webapp"), 10010, 10002);
    ...
    boundaryPanel.add(new Button("Get connected widgets to Task shape", new ClickHandler() {
      
      @Override
      public void onClick(ClickEvent event) {
        List<Widget> widgets = getConnectedWidgets(shapeForTask);
        StringBuilder b = new StringBuilder();
        b.append("Connected widgets:\n");
        
        for (Widget widget : widgets) {
          b.append("- widget: " + widget + '\n');
        }
